...
public class PrototypeAlbum implements PrototypeEntertainment{
	private String name; 
	@Override
...
//	     
	...
	public PrototypeAlbum clone() throws CloneNotSupportedException {
		System.out.println("Creating the clone of Album");
